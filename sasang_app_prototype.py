...
# 예: https://drive.google.com/file/d/11ZZu7A_YT-2iY8fNwT7hD9ghMGFOT3TQ/view?usp=sharing 
#     -> 고유 ID는 "11ZZu7A_YT-2iY8fNwT7hD9ghMGFOT3TQ" 입니다.
# ==============================================================================
GDRIVE_FILE_IDS = {
    # 13개 기본 핵심 경혈 이미지
...
def get_gdrive_image_url(image_filename):
    ...
    if file_id and file_id.strip():
        # 구글 드라이브의 타사 쿠키 우회 전용 초고속 이미지 호스팅 서버 경로
...
def load_symptom_db():
    ...
    # Local 이나 Streamlit Cloud에서 파일 경로 찾기
...
if not st.session_state.diagnosis_completed:
    ...
    st.write("질문을 읽어보신 후, 본인에게 가장 가깝다고 생각되는 항목을 선택해 주세요.")
