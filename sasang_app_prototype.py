...
CONSTITUTION_DATA = {'소양인': {'acupoints_acute': [{'method': '급성 소화불량이나 상체의 열을 전신으로 고르게 분산시키는 요혈입니다. 지압봉 등을 사용해 묵직한 자극을 줍니다.',
                              'name': '족삼리 (足三里, ST36)',
                              'position': '독비혈(무릎 바깥쪽 오목한 곳)에서 아래로 3치 내려간 곳, 정강이뼈 가쪽 한 손가락 너비'},
                             {'method': '소양인의 대변 불통 및 변비 증상이 올 때 온몸의 삼초 기운을 소통시켜 변을 시원하게 보게 돕는 특효혈입니다. 손가락으로 강하게 흔들며 '
                                        '압박합니다.',
                              'name': '지구 (支溝, TE6)',
                              'position': '손등 손목 주름에서 위로 3치 올라간 두 뼈 사이의 오목한 곳'}],
         'acupoints_daily': [{'method': '몸 안의 비생리적인 열 독소와 수분을 소통시켜 비뇨기와 위장을 돕습니다. 엄지손가락으로 꾹꾹 눌러 지압해 줍니다.',
                              'name': '음릉천 (陰陵泉, SP9)',
         ...
         'description': "비장의 기능은 성하고 신장의 기능은 약한 '비대신소(脾大腎小)'의 장부 구조를 지녔습니다. 매사에 날래고 용맹하며, 공적인 업무를 시원스럽게 돌파하는 추진력이 "
                        '강합니다.',
         'herbs': [{'efficacy': '약해지기 쉬운 신장의 기운을 보하고, 체내의 음액(수분)을 채워주어 눈을 밝게 하고 피로를 풉니다.',
                    'name': '구기자 (枸杞子)',
                    'processing': "가을에 붉게 익은 구기자 열매를 따서 깨끗이 씻은 후, 통풍이 잘되는 그늘에서 반쯤 말렸다가 '막걸리를 살짝 뿌려 시루에 한 번 찐 다음(주증, "
                                  "酒蒸)' 다시 햇볕에 완벽하게 건조해 사용합니다. 이렇게 하면 신장을 보하는 약성이 훨씬 깊어집니다."},
                   {'efficacy': '정력을 보강하고 오줌이 잦은 증상을 치료하며, 소양인의 하체를 든든하게 받쳐줍니다.',
                    'name': '산수유 (山茱萸)',
                    'processing': "붉은 산수유 열매에서 '반드시 씨앗을 제거(去核)'해야 합니다. 산수유 씨앗은 정력을 오히려 상하게 하므로 과육만 발라내어 건조한 뒤 사용해야 "
                                  '합니다.'}],
         'name_hanja': '少陽人',
 ...
 '소음인': {'acupoints_acute': [{'method': '급체하거나 머리가 아플 때 족삼리와 함께 사용하여 막힌 기를 강하게 뚫어줍니다. 찌릿한 느낌이 손끝까지 가도록 강하게 5초씩 지압합니다.',
                              'name': '합곡 (合谷, LI4)',
         ...
         'acupoints_daily': [{'method': '하복부를 따뜻하게 하고 소화기 기운을 북돋우는 핵심 양생혈입니다. 부드러운 뜸(온구법)을 뜨거나 둥글게 원을 그리며 따뜻한 온기가 돌 '
                                        '때까지 마사지합니다.',
                              'name': '삼음교 (三陰交, SP6)',
         ...
         'description': "신장의 기능은 성하고 비장의 기능은 약한 '신대비소(腎大脾小)'의 장부 구조를 지녔습니다. 성격이 침착하고 꼼꼼하며, 예의가 바르고 다른 이들을 다독이는 일에 "
                        '뛰어납니다.',
         'herbs': [{'efficacy': '비위의 약한 기운을 북돋우고 양기를 채워주어 손발을 따뜻하게 하고 소화력을 대폭 끌어올립니다.',
                    'name': '인삼 (人參)',
                    'processing': "수삼을 깨끗이 씻어 뇌두(머리 부분)를 잘라낸 뒤(뇌두는 구토를 유발할 수 있어 반드시 제거), '얇게 썰어 말리거나', '꿀에 재워 재증(쪄서 "
                                  "말림)'하여 약성을 순하게 만든 뒤 사용합니다."},
                   {'efficacy': '위장을 튼튼하게 하고 뱃속의 차가운 물기를 없애주어 소화불량과 설사를 멈추게 합니다.',
                    'name': '백출 (白朮, 삽주뿌리)',
                    'processing': "삽주 뿌리를 깨끗이 씻고 겉면의 흙을 제거한 뒤, '쌀뜨물에 하루 동안 담가두어(미감침, 米泔浸)' 기름기를 뺀 다음, 약한 불에 구워 건조하여 "
                                  '사용합니다.'}],
         'name_hanja': '少陰人',
 ...
 '태양인': {'acupoints_acute': [{'method': '음식물이 역류하거나 상체에 가래가 끓고 기가 거꾸로 솟구칠 때 지압을 통해 기운을 전신으로 빠르게 하향 소통시켜 줍니다.',
                              'name': '합곡 (合谷, LI4)',
         ...
         'acupoints_daily': [{'method': '약하기 쉬운 하체와 신장/간 기운을 뒤에서 든든히 받쳐줍니다. 양손을 비벼 따뜻하게 한 뒤 허리 뒤를 쓸어내리거나 지긋이 눌러줍니다.',
                              'name': '신수 (腎兪, BL23)',
         ...
         'description': "폐의 기능은 성하고 간의 기능은 약한 '폐대간소(肺大肝小)'의 장부 구조를 지녔습니다. 목덜미 기세가 웅장하며 거침없는 소통 능력과 대인 관계 리더십을 발휘합니다. "
                        '극히 드문 체질입니다.',
         'herbs': [{'efficacy': '약한 간 기운과 뼈를 튼튼하게 하여 하체의 힘을 기르고 근육이 마르는 것을 방지합니다.',
                    'name': '오가피 (五加皮, 가시오갈피 뿌리껍질)',
                    'processing': "오가피의 가지나 뿌리 껍질을 채취하여 깨끗이 씻은 후 물기를 빼고 적당한 크기로 썹니다. 약성을 더 부드럽고 따뜻하게 하기 위해 '소금물에 살짝 "
                                  "담갔다가 꺼내어 볶아서(염수초, 鹽水炒)' 사용합니다."},
                   {'efficacy': '기의 흐름을 원활하게 조절하여 식도가 좁아져 음식을 잘 넘기지 못하는 구토 증상을 가라앉히고 하체 다리 근육의 쥐를 풀어줍니다.',
                    'name': '모과 (木瓜)',
                    'processing': '가을철 잘 익은 모과를 깨끗이 씻어 4등분 한 후 속의 씨를 완전히 긁어냅니다. 얇게 썰어 끓는 물에 살짝 데쳐내거나 증기에 가볍게 찐 다음 햇볕에 '
                                  '건조하여 사용합니다.'}],
         'name_hanja': '太陽人',
 ...
 '태음인': {'acupoints_acute': [{'method': '과열되기 쉬운 간의 열을 내리고 혈압을 안정시킵니다. 다소 강한 압박감(뻐근함)이 느껴질 정도로 5초간 꾹 눌러줍니다.',
                              'name': '태충 (太衝, LR3)',
         ...
         'acupoints_daily': [{'method': '약해지기 쉬운 폐의 기운을 보강하기 위해, 손가락 끝으로 3초간 지긋이 누르기를 10회 반복합니다. 뜸을 가볍게 뜨는 것도 좋습니다.',
                              'name': '태연 (太淵, LU9)',
         ...
         'description': "간의 기능은 성하고 폐의 기능은 약한 '간대폐소(肝大肺小)'의 장부 구조를 타고났습니다. 체구가 듬직하고 기세가 장대하며, 무엇이든 묵묵히 성취해 내는 끈기가 "
                        '있습니다.',
         'herbs': [{'efficacy': '비위(위장)와 폐의 습한 기운을 없애주고 노폐물 배출을 도와 자양강장 및 체중 조절에 좋습니다.',
                    'name': '의이인 (薏苡仁, 율무)',
                    'processing': "껍질을 벗긴 율무를 흐르는 물에 깨끗이 씻어 말린 뒤, 가마솥이나 팬에 '약한 불로 노릇노릇해질 때까지 볶아서(초법, 炒法)' 사용합니다. 볶으면 찬 "
                                  '성질이 완화되고 고소해집니다.'},
                   {'efficacy': '간에 쌓인 열과 독소를 풀어주고 땀구멍을 열어주어 주독(술독) 및 초기 감기 발열을 가라앉힙니다.',
                    'name': '갈근 (葛根, 칡뿌리)',
                    'processing': "가을에 캔 칡뿌리를 깨끗이 씻어 겉껍질을 벗긴 후, 얇게 썰어 '햇볕에 바짝 건조'하여 사용합니다. 수분이 있으면 약효가 변질되므로 완전히 건조하는 "
                                  '것이 핵심입니다.'}],
         'name_hanja': '太陰人',
...
QUESTIONS = [{'category': '체형 및 외모 (기상)',
  'id': 1,
  'options': [{'scores': {'태양인': 1.0}, 'text': '목덜미 부근(목과 어깨 사이)의 기세는 우뚝 솟아 발달해 보이나, 상대적으로 엉덩이와 하체가 외롭고 빈약해 보인다.'},
              ...
              {'scores': {'소음인': 1.0},
               'text': '엉덩이와 골반(이둔) 부위가 잘 발달하여 앉아 있는 자세가 매우 안정적이고 아담하지만, 가슴둘레와 상체 기세가 좁고 빈약해 보인다.'}],
  'question': '거울을 보거나 남들이 말할 때, 나의 전체적인 신체 실루엣과 가장 가까운 것은 무엇인가요?',
  'weight': 1.0},
 {'category': '성격 및 재간 (성정)',
  'id': 2,
  'options': [{'scores': {'태양인': 1.0}, 'text': '새로운 사람들과 막힘없이 적극적으로 소통하고 대인 관계를 넓히는 일(교우)에 뛰어난 과단성이 있다.'},
 ...
 {'category': '완실무병 (건강할 때의 핵심 지표)',
  'id': 3,
  'options': [{'scores': {'태양인': 1.5}, 'text': '소변이 막힘없이 시원하게 아주 잘 나오고 양이 넉넉할 때 몸이 가볍다.'},
 ...
 {'category': '특이 병증 (몸이 지치거나 아플 때)',
  'id': 4,
  'options': [{'scores': {'태양인': 1.5}, 'text': '음식물을 삼키는 목구멍이나 식도가 뻑뻑하게 좁아지는 느낌이 들거나, 속에서 신침이나 맑은 침이 솟구쳐 토하려 한다.'},
              {'scores': {'소양인': 1.5}, 'text': '대변이 하루이틀만 통하지 않아도 아랫배가 더부룩해지면서 가슴 속이 불이 붙는 듯이 뜨거워지고 머리가 지끈거린다.'},
              {'scores': {'태음인': 1.5},
               'text': '기가 위로 솟구치며 이유 없이 가슴이 쿵쾅거리고 울렁거리거나(정충증), 눈꺼풀이 미세하게 떨리고 눈 속 깊은 곳이 쏘듯이 아프다.'},
              {'scores': {'소음인': 1.5},
               'text': '가끔 평소에 깊은 한숨을 크게 쉬며, 몸살 기운에 억지로 땀을 흘리고 나면 힘이 쏙 빠지고 몸이 더 처지고 극도로 피로해진다.'}],
  'question': '극도로 피곤하거나 컨디션이 악화되었을 때 몸에서 즉각적으로 나타나는 고유한 불편함은 무엇인가요?',
  'weight': 1.5},
 {'category': '피부 및 뼈마디의 감각 (정밀 확인)',
  'id': 5,
  'options': [{'scores': {'태양인': 1.5}, 'text': '피부나 근육질이 비교적 조밀하지 못하고 살결이 거칠거나 보통이며, 서 있는 하반신의 관절이 쉽게 떨리거나 허약하다.'},
